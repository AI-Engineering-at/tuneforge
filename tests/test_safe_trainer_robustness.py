...
def test_shield_dormant_on_safe_loss():
    ...
    loss_out = trainer.training_step(model, {"dummy": "input"})
    
    # Surgeries performed should be 0 because shield is dormant
    trainer.log.assert_called_with({'zeroth_loss': 0.10000000149011612, 'zeroth_surgeries': 0, 'zeroth_shield_active': 0})
